defmodule CsvUploader.DataUploader.InboundBatchRequest do
  use Ecto.Schema
  import Ecto.Changeset


  @primary_key {:batch_request_code, :string, autogenerate: false}
  schema "inbound_batch_requests" do
  ...
  @doc false
  def changeset(inbound_batch_request, attrs) do
    inbound_batch_request
